# Demo 1 Controller: Weather Function Agent
#
# This demo shows how to create an advanced function that retrieves
# weather data and integrate it into an AIsuru agent embedded in a web component.
