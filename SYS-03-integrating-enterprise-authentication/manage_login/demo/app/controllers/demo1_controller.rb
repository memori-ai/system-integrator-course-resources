# Demo 1 Controller: Web Component with showLogin
# 
# This demo shows how to embed the AIsuru web component with 
# showLogin="true", which handles authentication autonomously
# through the built-in login panel.
